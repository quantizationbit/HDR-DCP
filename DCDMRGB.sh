...
mkdir "TIFPQ"${NITS[0]}${MINS[0]} "TIFPQ"${NITS[1]}${MINS[0]} "TIFPQ"${NITS[2]}${MINS[0]} 
mkdir "TIFPQ"${NITS[0]}${MINS[1]} "TIFPQ"${NITS[1]}${MINS[1]} "TIFPQ"${NITS[2]}${MINS[1]} 
mkdir "TIFPQ"${NITS[0]}${MINS[2]} "TIFPQ"${NITS[1]}${MINS[2]} "TIFPQ"${NITS[2]}${MINS[2]} 
mkdir "TIFPQ"${NITS[0]}${MINS[3]} "TIFPQ"${NITS[1]}${MINS[3]} "TIFPQ"${NITS[2]}${MINS[3]} 
mkdir "TIFPQ"${NITS[0]}${MINS[4]} "TIFPQ"${NITS[1]}${MINS[4]} "TIFPQ"${NITS[2]}${MINS[4]} 
mkdir "TIFPQ"${NITS[0]}${MINS[5]} "TIFPQ"${NITS[1]}${MINS[5]} "TIFPQ"${NITS[2]}${MINS[5]} 
...
for filename in /EDRDATA2/StEM_Dolby_PQ/StEM*Magic*2020/*30[0-9]*tif ; do
...
(ctlrender -force -ctl ./InvODT.Academy.Rec2020_ST2084_4000nits.ctl -param1 aIn 1.0 $filename -format exr32 TMP$c1".exr"; \
 ...
 \
 \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[2]} -param1 MIN ${MINS[0]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[2]}${MINS[0]}"/TIFPQ"${NITS[2]}${MINS[0]}$numStr".tiff"; \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[1]} -param1 MIN ${MINS[0]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[1]}${MINS[0]}"/TIFPQ"${NITS[1]}${MINS[0]}$numStr".tiff"; \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[0]} -param1 MIN ${MINS[0]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[0]}${MINS[0]}"/TIFPQ"${NITS[0]}${MINS[0]}$numStr".tiff"; \
 \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[2]} -param1 MIN ${MINS[1]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[2]}${MINS[1]}"/TIFPQ"${NITS[2]}${MINS[1]}$numStr".tiff"; \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[1]} -param1 MIN ${MINS[1]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[1]}${MINS[1]}"/TIFPQ"${NITS[1]}${MINS[1]}$numStr".tiff"; \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[0]} -param1 MIN ${MINS[1]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[0]}${MINS[1]}"/TIFPQ"${NITS[0]}${MINS[1]}$numStr".tiff"; \
 \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[2]} -param1 MIN ${MINS[2]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[2]}${MINS[2]}"/TIFPQ"${NITS[2]}${MINS[2]}$numStr".tiff"; \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[1]} -param1 MIN ${MINS[2]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[1]}${MINS[2]}"/TIFPQ"${NITS[1]}${MINS[2]}$numStr".tiff"; \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[0]} -param1 MIN ${MINS[2]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[0]}${MINS[2]}"/TIFPQ"${NITS[0]}${MINS[2]}$numStr".tiff"; \
 \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[2]} -param1 MIN ${MINS[3]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[2]}${MINS[3]}"/TIFPQ"${NITS[2]}${MINS[3]}$numStr".tiff"; \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[1]} -param1 MIN ${MINS[3]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[1]}${MINS[3]}"/TIFPQ"${NITS[1]}${MINS[3]}$numStr".tiff"; \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[0]} -param1 MIN ${MINS[3]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[0]}${MINS[3]}"/TIFPQ"${NITS[0]}${MINS[3]}$numStr".tiff"; \
 \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[2]} -param1 MIN ${MINS[4]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[2]}${MINS[4]}"/TIFPQ"${NITS[2]}${MINS[4]}$numStr".tiff"; \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[1]} -param1 MIN ${MINS[4]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[1]}${MINS[4]}"/TIFPQ"${NITS[1]}${MINS[4]}$numStr".tiff"; \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[0]} -param1 MIN ${MINS[4]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[0]}${MINS[4]}"/TIFPQ"${NITS[0]}${MINS[4]}$numStr".tiff"; \
 \
ctlrender -force  -ctl ./ODT.Academy.P3DCI_XXXXnits.ctl -param1 aIn 1.0 -param1 MAX ${NITS[2]} -param1 MIN ${MINS[5]} -param1 PQ 1 TMP$c1".exr" -format tiff16 "TIFPQ"${NITS[2]}${MINS[5]}"/TIFPQ"${NITS[2]}${MINS[5]}$numStr".tiff"; \
